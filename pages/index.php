  ...
  <body class="layout-wide">
    ...
    <nav class="site-navbar site-navbar-transparent navbar navbar-expand-lg navbar-dark fixed-top bg-white shadow-light p-lg-4" data-navbar-base="navbar-dark" data-navbar-toggled="navbar-light" data-navbar-scrolled="navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <!-- Button -->
        <a class="btn btn-primary d-block d-lg-inline-block ml-lg-3" href="https://themeforest.net/item/lana-creative-coming-soon-template/20423954" target="_blank" rel="noopener">Buy now</a>
    ...
    <div class="overlay overlay-global">
      <div class="overlay-inner bg-image-holder bg-cover">
        <img src="assets/images/image-4.jpg" alt="background">
      </div>
    ...
    <div class="ln-fullpage">
      ...
      <!-- Section - Our mission -->
      <section class="ln-section d-xl-flex" data-anchor="our-mission" data-tooltip="Our mission">
              ...
              <div class="portfolio-item mb-8">
                <div class="row">
                  ...
                  <div class="col-12 col-lg-5">
                    <div class="pt-lg-8">
                      <div class="divider divider-alt bg-white mt-0 mb-8 d-none d-lg-block"></div>
                      <h4 class="h3">Beautiful Girl</h4>
                      <p class="text-italic">Brand</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="portfolio-item">
                <div class="row">
                  ...
                  <div class="col-12 col-lg-5">
                    <div class="pt-lg-8">
                      <div class="divider divider-alt bg-white mt-0 mb-8 d-none d-lg-block"></div>
                      <h4 class="h3">Golden Gate Bridge</h4>
                      <p class="text-italic">Design</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-lg-5 mb-8 mb-lg-0">
              <div class="row">
                ...
                <div class="col-12 col-md-4 col-lg-6 animated" data-animation="fadeInUp" data-animation-delay="150">
                  ...
                  <a href="mailto:hello@example.com" class="text-white">hello@example.com</a></p>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10 col-xl-12 col-xxl-10 mx-auto text-center">
            ...
            <p class="mb-0">© 2020 Lana - All Rights Reserved - <a href="#!" class="text-gray-400">Terms of Service</a></p>
          </div>
        </div>
      </div>
    </footer><!-- footer end -->
